...
public class AgentieSingletonSimpleFactory {
    private static  AgentieSingletonSimpleFactory instanta =null;

    private AgentieSingletonSimpleFactory() {
    }

    public static  synchronized  AgentieSingletonSimpleFactory getInstanta() {
        if(instanta == null) {
            instanta=new AgentieSingletonSimpleFactory();
        }
        return instanta;
    }
